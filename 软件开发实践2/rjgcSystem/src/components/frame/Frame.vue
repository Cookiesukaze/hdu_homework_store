            ...
            <div class="science_header_right">
                ...
                <el-dropdown>
                    <span class="science_el-dropdown-link">
                        {{ username }}<i class="el-icon-arrow-down el-icon--right" style="color:#606266;margin-bottom:3px"></i>
                    </span>
        ...
        <el-container class="science_rela_container" >
            ...
            <el-aside class="science_aside" width="180px" height="100%" style="overflow-y:hidden;height: 94vh;">
                ...
                <el-col :span="24" class="science_el-col" style="margin-top:20px">
                    ...
                    <el-menu active-text-color="#3770ff !important;" router="true" :default-active="defaultActive" @select="handleSelect" >
                        ...
                        <el-menu-item index="/violatequery" class="science_el-menu-item" style="padding-left: 30px;">
                            <i class="el-icon-menu"></i>
                            <span slot="title">违约查询</span>
                        </el-menu-item>
                        <el-menu-item index="/violatequery1" class="science_el-menu-item" style="padding-left: 30px;">
                            <i class="el-icon-menu"></i>
                            <span slot="title">违约查询(风控)</span>
                        </el-menu-item>
                        <el-menu-item index="/violatequery2" class="science_el-menu-item" style="padding-left: 30px;">
                            <i class="el-icon-menu"></i>
                            <span slot="title">违约查询(负责人)</span>
                        </el-menu-item>
                        <el-menu-item index="/violateapply" class="science_el-menu-item" style="padding-left: 30px;">
                            <i class="el-icon-edit"></i>
                            <span slot="title">违约申请</span>
                        </el-menu-item>
                        <el-menu-item index="/respawnapply" class="science_el-menu-item" style="padding-left: 30px;">
                            <i class="el-icon-edit"></i>
                            <span slot="title">重生申请</span>
                        </el-menu-item>
                        ...
                        <el-menu-item index="/respawnverify" class="science_el-menu-item" style="padding-left: 30px;">
                            <i class="el-icon-document-checked"></i>
                            <span slot="title">重生审核</span>
                        </el-menu-item>
...
export default {
    ...
    watch: {
        $route() {
            console.log("检测到路由变化"+this.$route.path)
            // this.handleSelect(this.activeIndex)
            this.defaultActive = this.$route.path;
            this.handleSelect(this.$route.path.substr(1))
        }},
    methods: {
        handleSelect (index) {

            this.activeIndex = index.substr(1)
        }
    }
}
</script>
